...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" fill="currentColor"></path></svg>`,
      name: "Image Shortener",
      path: "/app/image-shortener",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3 5.25A2.25 2.25 0 0 1 5.25 3h13.5A2.25 2.25 0 0 1 21 5.25v13.5A2.25 2.25 0 0 1 18.75 21H5.25A2.25 2.25 0 0 1 3 18.75V5.25Zm3 0v13.5h13.5V5.25H6Zm1.5 3a.75.75 0 0 1 .75-.75h7.5a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1-.75-.75Zm.75 3.75a.75.75 0 0 0 0 1.5h7.5a.75.75 0 0 0 0-1.5h-7.5Zm0 3a.75.75 0 0 0 0 1.5h4.5a.75.75 0 0 0 0-1.5h-4.5Z" fill="currentColor"></path></svg>`,
      name: "My Uploaded Images",
      path: "/app/my-uploaded-images",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 3.75a.75.75 0 0 1 .75.75v6.75h6.75a.75.75 0 0 1 0 1.5h-6.75v6.75a.75.75 0 0 1-1.5 0v-6.75H4.5a.75.75 0 0 1 0-1.5h6.75V4.5a.75.75 0 0 1 .75-.75Z" fill="currentColor"></path></svg>`,
      name: "Create Category",
      path: "/app/create-category",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.25 4.5a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 .75.75v6a.75.75 0 0 1-1.5 0V5.25h-4.5v13.5h4.5v-1.5a.75.75 0 0 1 1.5 0v2.25a.75.75 0 0 1-.75.75h-6a.75.75 0 0 1-.75-.75v-15Z" fill="currentColor"></path></svg>`,
      name: "Create Item",
      path: "/app/create-item",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695 18.683 18.683 0 0 1-5.594 1.744.75.75 0 0 1-.584-.31 9.187 9.187 0 0 0-2.466-2.414.75.75 0 0 1-.437-.695ZM2.25 10.875a.75.75 0 0 1 .75-.75h18a.75.75 0 0 1 0 1.5H3a.75.75 0 0 1-.75-.75Z" fill="currentColor"></path></svg>`,
      name: "My Shortlist",
      path: "/app/my-shortlist",
    },
    {
      ...
      name: "Dashboard",
      subItems: [
        { name: "Ecommerce", path: "/app/dashboard" },
      ],
    },
    {
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.75 5.25C3.75 4.00736 4.75736 3 6 3H18C19.2426 3 20.25 4.00736 20.25 5.25V18.75C20.25 19.9926 19.2426 21 18 21H6C4.75736 21 3.75 19.9926 3.75 18.75V5.25ZM6 4.5C5.58579 4.5 5.25 4.83579 5.25 5.25V18.75C5.25 19.1642 5.58579 19.5 6 19.5H9.75V4.5H6ZM11.25 4.5V19.5H18C18.4142 19.5 18.75 19.1642 18.75 18.75V5.25C18.75 4.83579 18.4142 4.5 18 4.5H11.25Z" fill="currentColor"></path></svg>`,
      name: "Messages",
      path: "/app/messages",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3 6a3 3 0 013-3h12a3 3 0 013 3v12a3 3 0 01-3 3H6a3 3 0 01-3-3V6zm4.5 7.5a.75.75 0 01.75-.75h2.25a.75.75 0 010 1.5H8.25a.75.75 0 01-.75-.75zM6 15a.75.75 0 00.75.75h9a.75.75 0 000-1.5h-9A.75.75 0 006 15zm2.25-3a.75.75 0 01.75-.75h6a.75.75 0 010 1.5H9a.75.75 0 01-.75-.75z" fill="currentColor"></path></svg>`,
      name: "Wall",
      path: "/app/wall",
    },
    {
      ...
      subItems: [
        { name: "Form Elements", path: "/app/form-elements", pro: false }
      ],
    },
    {
      name: "Tables",
      ...
      subItems: [
        { name: "Basic Tables", path: "/app/basic-tables", pro: false },
      ],
    },
    {
      name: "Pages",
      ...
      subItems: [
        { name: "Blank Page", path: "/app/blank", pro: false },
        { name: "404 Error", path: "/app/error-404", pro: false },
      ],
    },
  ];
  // Others nav items
  othersItems: NavItem[] = [
    {
      ...
      name: "Charts",
      subItems: [
        { name: "Line Chart", path: "/app/line-chart", pro: false },
        { name: "Bar Chart", path: "/app/bar-chart", pro: false },
      ],
    },
    {
      ...
      name: "UI Elements",
      subItems: [
        { name: "Alerts", path: "/app/alerts", pro: false },
        { name: "Avatar", path: "/app/avatars", pro: false },
        { name: "Badge", path: "/app/badge", pro: false },
        { name: "Buttons", path: "/app/buttons", pro: false },
        { name: "Images", path: "/app/images", pro: false },
        { name: "Videos", path: "/app/videos", pro: false },
      ],
    },
    {
